...
define('SOURCEHUB_VERSION', '2.1.0');
...
// Load Action Scheduler library for reliable background task execution
require_once SOURCEHUB_PLUGIN_DIR . 'lib/action-scheduler/action-scheduler.php';
...
final class SourceHub {
    ...
    public function activate() {
        ...
        SourceHub_Messaging::create_tables();
